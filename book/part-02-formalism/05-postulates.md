...
- **Measurement is irreversible.** The state collapses to the
  ...
  alone (the interaction itself can be modelled as reversible unitary
...
division of labour is what makes interference work.
...
- **Conservation of information** under closed-system evolution is why noise gets modelled via quantum channels (Chapter 10; the
