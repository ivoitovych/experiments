...
- **Variational algorithms and quantum machine learning**: PennyLane. Differentiation-first, multi-backend, integrates with NumPy/JAX/PyTorch/TensorFlow. In the author's view, the most pedagogical library for understanding parameter-shift gradients (one of several differentiation methods it supports).
