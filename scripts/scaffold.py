...
ENTRIES: list[dict] = [
    ...
    },
    {
        "kind": "front",
        "dir": "00-front-matter",
        "file": "03-historical-prelude.md",
        "title": "Chapter 0. Historical Prelude — From Quanta to Qubits",
        "sections": [
            "The Classical World Before the Crisis",
            "The Classical Crisis: Bugs That Would Not Go Away",
            "Old Quantum Theory: Patching Classical Physics, 1900–1925",
            "The Birth of Modern Quantum Mechanics, 1925–1927",
            "Dirac, von Neumann, and the Formal Language of Quantum Theory",
            "Entanglement: From Philosophical Problem to Operational Resource",
            "Quantum Mechanics Becomes Engineering",
            "Computation Becomes Formal",
            "Information Becomes Mathematical and Physical",
            "Quantum Information Before Quantum Computers",
            "The Birth of Quantum Computing: Possibility, Necessity, Universality",
            "The Algorithmic Shock: From Oracle Separations to Shor and Grover",
            "Quantum Error Correction: Making the Impossible Plausible",
            "The Hardware Era: From Laboratory Systems to Competing Platforms",
            "NISQ, Quantum Advantage, and the Present Reality",
            "What This History Gives the Practicing Developer",
        ],
    },
