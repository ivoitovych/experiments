...
- **Claim** (anchor): "Pauli-basis relations: $H X H = Z$, $H Z H = X$, $H Y H = -Y$. So $H$ exchanges $X$ and $Z$ in the Heisenberg picture."
- **Method**: derivation
...
- **Claim** (anchor): "The Toffoli is **not** a member of the Clifford group; together with any Clifford generating set it provides universal quantum computation."
- **Method**: external
